...
public class TokenLoginFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException {
        ...
        Authentication authentication = new UsernamePasswordAuthenticationToken(loginDTO.getUserName(), loginDTO.getPwd());
    ...
    protected void successfulAuthentication(HttpServletRequest request,
        ...
        String token = JWTUtil.createToken(cusotmUser.getSystemUser().getUserId(), cusotmUser.getSystemUser().getUserName());
    ...
    protected void unsuccessfulAuthentication(HttpServletRequest request,
        ...
        if(failed instanceof RuntimeException){
            ResponseUtil.out(response,Result.fail(400,failed.getLocalizedMessage()));
        }else{
            //TODO 改成访问次数太多
